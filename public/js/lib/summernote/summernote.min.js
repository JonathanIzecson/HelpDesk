...
!(function (a) {
  ...
  if (h) {
    ...
    i && (b = parseFloat(i[1])),
      (i = /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(g)),
      i && (b = parseFloat(i[1]));
  }
  var j = /Edge\/\d+/.test(g),
    k = !!window.CodeMirror;
  if (!k && e && require)
    if (require.hasOwnProperty("resolve"))
      ...
      require.hasOwnProperty("specified") &&
        (k = require.specified("codemirror"));
  var m = {
      ...
      var b = function (b) {
        ...
        E = function (a, b) {
          ...
          return (
            a.previousSibling &&
              b(a.previousSibling) &&
              d.push(a.previousSibling),
            d.push(a),
            a.nextSibling && b(a.nextSibling) && d.push(a.nextSibling),
            d
          );
        },
        ...
        H = function (a) {
          ...
          return 0 === b
            ? !0
            : g(a) || 1 !== b || a.innerHTML !== F
            ? d.all(a.childNodes, g) && "" === a.innerHTML
              ? !0
              : !1
            : !0;
        },
          ...
          return e.length
            ? 1 === e.length
              ...
              : e.reduce(function (a, c) {
                  return (
                    a === b.node && (a = la(b, d)),
                    la({ node: c, offset: a ? p.position(a) : G(c) }, d)
                  );
                })
            : null;
        },
        na = function (a, b) {
          ...
          return (
            i || e !== a.node || (i = a.node.childNodes[a.offset]),
            { rightNode: i, container: e }
          );
        },
        oa = function (a) {
    ...
    q = function (b, e) {
      ...
      return (
        ...
        (this.initialize = function () {
          return (
            (this.layoutInfo = g.createLayout(b, e)),
            this._initialize(),
            b.hide(),
            this
          );
        ...
        (this.destroy = function () {
          this._destroy(),
            ...
            g.removeLayout(b, this.layoutInfo);
        }),
        (this.reset = function () {
          var a = f.isDisabled();
          this.code(p.emptyPara),
            this._destroy(),
            this._initialize(),
            a && f.disable();
        }),
        ...
        (this.code = function (a) {
          ...
          return void 0 === a
            ...
            : (c
                ? this.layoutInfo.codable.val(a)
                : this.layoutInfo.editable.html(a),
              b.val(a),
        ...
        (this.initializeModule = function (a) {
          ...
          (d.shouldInitialize = d.shouldInitialize || c.ok),
            d.shouldInitialize() &&
              (d.initialize && d.initialize(),
              d.events && p.attachEvents(b, d.events));
        }),
        (this.module = function (a, b, c) {
          return 1 === arguments.length
            ? this.modules[a]
            : ((this.modules[a] = new b(this)),
              void (c || this.initializeModule(a)));
        }),
        (this.removeModule = function (a) {
          var c = this.modules[a];
          c.shouldInitialize() &&
            (c.events && p.detachEvents(b, c.events), c.destroy && c.destroy()),
        ...
        (this.createInvokeHandler = function (b, c) {
          return function (d) {
            d.preventDefault(),
              f.invoke(
                b,
                c || a(d.target).closest("[data-value]").data("value")
              );
          };
        }),
  ...
  a.fn.extend({
    summernote: function () {
      ...
      (f = a.extend({}, a.summernote.options, f)),
        (f.langInfo = a.extend(
          !0,
          {},
          a.summernote.lang["en-US"],
          a.summernote.lang[f.lang]
        )),
        this.each(function (b, c) {
          ...
          if (!d.data("summernote")) {
            var e = new q(d, f);
            d.data("summernote", e),
              d.data("summernote").triggerEvent("init", e.layoutInfo);
          }
        });
      var g = this.first();
      if (g.length) {
  ...
  var K,
      ...
      var b = function (a, b) {
          ...
          for (c = 0; c < h.length; c++)
            if (!p.isText(h[c])) {
              if (
                ...
                g.compareEndPoints("StartToStart", a) >= 0)
              )
                break;
              e = h[c];
            }
          if (0 !== c && p.isText(h[c - 1])) {
            var i = document.body.createTextRange(),
              j = null;
            i.moveToElementText(e || f),
              i.collapse(!e),
              (j = e ? e.nextSibling : f.firstChild);
            var k = a.duplicate();
            k.setEndPoint("StartToStart", i);
            for (
              var l = k.text.replace(/[\r\n]/g, "").length;
              l > j.nodeValue.length && j.nextSibling;
            ...
            b &&
              j.nextSibling &&
              p.isText(j.nextSibling) &&
              l === j.nodeValue.length &&
              ((l -= j.nodeValue.length), (j = j.nextSibling)),
              (f = j),
              (c = l);
          }
        ...
        e = function (a) {
          var b = function (a, e) {
            ...
            f = b(a.node, a.offset);
          return (
            e.moveToElementText(f.node),
            e.collapse(f.collapseToStart),
            e.moveStart("character", f.offset),
            e
          );
        },
        f = function (b, g, h, i) {
          ...
          (this.getPoints = function () {
            ...
            (this.normalize = function () {
              var a = function (a, b) {
                  if (
                    (p.isVisiblePoint(a) && !p.isEdgePoint(a)) ||
                    (p.isVisiblePoint(a) && p.isRightEdgePoint(a) && !b) ||
                    (p.isVisiblePoint(a) && p.isLeftEdgePoint(a) && b) ||
                    (p.isVisiblePoint(a) &&
                      p.isBlock(a.node) &&
                      p.isEmpty(a.node))
                  )
                  ...
                  if (
                    ((p.isLeftEdgePointOf(a, c) ||
                      p.isVoid(p.prevPoint(a).node)) &&
                      !b) ||
                    ((p.isRightEdgePointOf(a, c) ||
                      p.isVoid(p.nextPoint(a).node)) &&
                      b)
                  ) {
                  ...
                  var d = b
                    ? p.nextPointUntil(p.nextPoint(a), p.isVisiblePoint)
                    : p.prevPointUntil(p.prevPoint(a), p.isVisiblePoint);
                  return d || a;
                },
                ...
                p.walkPoint(
                  ...
                  function (b) {
                    if (!p.isEditable(b.node)) {
                      var c;
                      f
                        ? (p.isLeftEdgePoint(b) && j.push(b.node),
                          p.isRightEdgePoint(b) &&
                            d.contains(j, b.node) &&
                            (c = b.node))
                        : (c = e ? p.ancestor(b.node, a) : b.node),
                        c && a(c) && i.push(c);
                    }
                  },
                  !0
            ...
            (this.expand = function (a) {
              ...
              return (
                c && ((e.sc = c), (e.so = 0)),
                d && ((e.ec = d), (e.eo = p.nodeLength(d))),
                new f(e.sc, e.so, e.ec, e.eo)
              );
            }),
            ...
            (this.splitText = function () {
              ...
              return (
                p.isText(h) &&
                  !p.isEdgePoint(this.getEndPoint()) &&
                  h.splitText(i),
                p.isText(b) &&
                  !p.isEdgePoint(this.getStartPoint()) &&
                  ((c.sc = b.splitText(g)),
                  (c.so = 0),
                  a && ((c.ec = c.sc), (c.eo = i - g))),
                new f(c.sc, c.so, c.ec, c.eo)
              );
            }),
            (this.deleteContents = function () {
              ...
              return (
                a.each(c, function (a, b) {
                  var c = b.parentNode;
                  e.node !== c && 1 === p.nodeLength(c) && g.push(c),
                    p.remove(b, !1);
                }),
          ...
          (this.isOnEditable = k(p.isEditable)),
            (this.isOnList = k(p.isList)),
            (this.isOnAnchor = k(p.isAnchor)),
            (this.isOnCell = k(p.isCell)),
            ...
            (this.wrapBodyInlineWithPara = function () {
              if (p.isBodyContainer(b) && p.isEmpty(b))
                return (
                  (b.innerHTML = p.emptyPara),
                  new f(b.firstChild, 0, b.firstChild, 0)
                );
              ...
              if (p.isInline(a.sc)) {
                ...
                (e = d.last(g)),
                  p.isInline(e) ||
                    (e = g[g.length - 2] || a.sc.childNodes[a.so]);
              } else e = a.sc.childNodes[a.so > 0 ? a.so - 1 : 0];
              var h = p.listPrev(e, p.isParaInline).reverse();
              if (
                ((h = h.concat(p.listNext(e.nextSibling, p.isParaInline))),
                h.length)
              ) {
            ...
            (this.getWordRange = function (a) {
              ...
              return (
                a &&
                  (b = p.nextPointUntil(b, function (a) {
                    return !p.isCharPoint(a);
                  })),
            ...
            (this.bookmark = function (a) {
              return {
                s: { path: p.makeOffsetPath(a, b), offset: g },
                e: { path: p.makeOffsetPath(a, h), offset: i },
              };
            }),
            (this.paraBookmark = function (a) {
              return {
                s: { path: d.tail(p.makeOffsetPath(d.head(a), b)), offset: g },
                e: { path: d.tail(p.makeOffsetPath(d.last(a), h)), offset: i },
              };
            }),
      ...
      return {
        create: function (a, b, c, d) {
          ...
          return e || 1 !== arguments.length
            ? e
            : ((e = this.createFromNode(arguments[0])),
              e.collapse(p.emptyPara === arguments[0].innerHTML));
        },
        createFromSelection: function () {
          ...
          if (m.isW3CRangeSupport) {
            ...
            p.isText(l.node) &&
              p.isLeftEdgePoint(l) &&
              p.isTextNode(n.node) &&
              p.isRightEdgePoint(n) &&
              n.node.nextSibling === l.node &&
              (l = n),
              (a = l.cont),
              (c = l.offset),
              (d = n.cont),
        ...
        createFromNode: function (a) {
          var b = a,
            ...
            e = p.nodeLength(d);
          return (
            p.isVoid(b) && ((c = p.listPrev(b).length - 1), (b = b.parentNode)),
            p.isBR(d)
              ? ((e = p.listPrev(d).length - 1), (d = d.parentNode))
              : p.isVoid(d) && ((e = p.listPrev(d).length), (d = d.parentNode)),
            this.create(b, c, d, e)
          );
        },
      ...
      var b = [],
        ...
        f = function (b) {
          null !== b.contents && a.html(b.contents),
            null !== b.bookmark && M.createFromBookmark(d, b.bookmark).select();
        };
      ...
      (this.fromNode = function (a) {
        ...
        (this.styleNodes = function (b, e) {
          ...
          var i = p.makePredByNodeName(f),
            j = b.nodes(p.isText, { fullyContains: !0 }).map(function (a) {
        ...
        (this.current = function (b) {
          ...
          return (
            (d.anchor = b.isOnAnchor() && p.ancestor(b.sc, p.isAnchor)),
            (d.ancestors = p.listAncestor(b.sc, p.isEditable)),
            (d.range = b),
            d
          );
        });
      ...
      (this.insertOrderedList = function (a) {
        ...
        (this.indent = function (b) {
          var e = this,
            ...
            g = f.nodes(p.isPara, { includeAncestor: !0 }),
            h = d.clusterBy(g, c.peq2("parentNode"));
          a.each(h, function (b, c) {
            var f = d.head(c);
            p.isLi(f)
              ? e.wrapList(c, f.parentNode.nodeName)
        ...
        (this.toggleList = function (e, f) {
          var g = M.create(f).wrapBodyInlineWithPara(),
            h = g.nodes(p.isPara, { includeAncestor: !0 }),
            i = g.paraBookmark(h),
          ...
          if (d.find(h, p.isPurePara)) {
            ...
            var l = g
              .nodes(p.isList, { includeAncestor: !0 })
              .filter(function (b) {
        ...
        (this.wrapList = function (a, b) {
          ...
          return (
            ...
            p.appendChildNodes(h, a),
            g && (p.appendChildNodes(h, d.from(g.childNodes)), p.remove(g)),
            a
          );
        }),
              ...
              var g = d.head(f),
                ...
                j =
                  i.childNodes.length > 1
                    ? p.splitTree(
                        i,
                        { node: h.parentNode, offset: p.position(h) + 1 },
                        { isSkipPaddingBlankHTML: !0 }
                      )
                    : null,
                k = p.splitTree(
                  i,
                  { node: g.parentNode, offset: p.position(g) },
                  { isSkipPaddingBlankHTML: !0 }
                );
              (f = c
                ? p.listDescendant(k, p.isLi)
                : d.from(k.childNodes).filter(p.isLi)),
                (c || !p.isList(i.parentNode)) &&
                  (f = f.map(function (a) {
        ...
        (this.insertParagraph = function (c) {
          ...
          if (f) {
            ...
            if (p.isEmpty(f) && p.isPara(f) && p.isBlockquote(f.parentNode))
              ...
              (g = g.concat(p.listDescendant(e, p.isEmptyAnchor))),
                a.each(g, function (a, b) {
                  p.remove(b);
                }),
                (p.isHeading(e) || p.isPre(e)) &&
                  p.isEmpty(e) &&
                  (e = p.replace(e, "p"));
            }
          } else {
    ...
    U = function (b) {
      ...
      (this.initialize = function () {
        g
          .on("keydown", function (a) {
            a.keyCode === L.code.ENTER && b.triggerEvent("enter", a),
              b.triggerEvent("keydown", a),
              h.shortcuts && !a.isDefaultPrevented() && c.handleKeyMap(a);
          })
          .on("keyup", function (a) {
        ...
        g.on(a, function () {
          ...
          !h.airMode && h.height && this.setHeight(h.height),
          !h.airMode && h.maxHeight && g.css("max-height", h.maxHeight),
          !h.airMode && h.minHeight && g.css("min-height", h.minHeight),
          r.recordUndo();
      }),
        (this.destroy = function () {
          g.off();
        ...
        (this.handleKeyMap = function (a) {
          ...
          f
            ...
            : L.isEdit(a.keyCode) && this.afterCommand();
        }),
        ...
        (this.undo = function () {
          b.triggerEvent("before.command", g.html()),
            r.undo(),
            b.triggerEvent("change", g.html());
        }),
        b.memo("help.undo", i.help.undo),
        (this.redo = function () {
          b.triggerEvent("before.command", g.html()),
            r.redo(),
            b.triggerEvent("change", g.html());
      ...
      for (
        var s = (this.beforeCommand = function () {
        ...
        (this[u[v]] = (function (a) {
          ...
          b.memo("help." + u[v], i.help[u[v]]);
      (this.tab = function () {
        var a = this.createRange();
        a.isCollapsed() && a.isOnCell()
          ? n.tab(a)
          : (s(), o.insertTab(a, h.tabSize), t());
      }),
        b.memo("help.tab", i.help.tab),
        (this.untab = function () {
          var a = this.createRange();
          a.isCollapsed() && a.isOnCell() && n.tab(a, !0);
        }),
        b.memo("help.untab", i.help.untab),
        ...
        b.memo("help.insertParagraph", i.help.insertParagraph),
        (this.insertOrderedList = this.wrapCommand(function () {
          q.insertOrderedList(j);
        })),
        b.memo("help.insertOrderedList", i.help.insertOrderedList),
        (this.insertUnorderedList = this.wrapCommand(function () {
          q.insertUnorderedList(j);
        })),
        b.memo("help.insertUnorderedList", i.help.insertUnorderedList),
        (this.indent = this.wrapCommand(function () {
          q.indent(j);
        })),
        b.memo("help.indent", i.help.indent),
        (this.outdent = this.wrapCommand(function () {
          q.outdent(j);
        })),
        b.memo("help.outdent", i.help.outdent),
        (this.insertImage = function (a, c) {
          return N.createImage(a, c)
            .then(function (a) {
              s(),
                "function" == typeof c
                  ? c(a)
                  : ("string" == typeof c && a.attr("data-filename", c),
                    a.css("width", Math.min(g.width(), a.width()))),
                a.show(),
                M.create(j).insertNode(a[0]),
                M.createFromNodeAfter(a[0]).select(),
                t();
            })
            .fail(function (a) {
        ...
        (this.insertImages = function (d) {
          a.each(d, function (a, d) {
            var e = d.name;
            h.maximumImageFileSize && h.maximumImageFileSize < d.size
              ? b.triggerEvent(
                  "image.upload.error",
                  i.image.maximumFileSizeError
                )
              : N.readFileAsDataURL(d)
                  .then(function (a) {
        ...
        (this.getSelectedText = function () {
          ...
          return (
            a.isOnAnchor() &&
              (a = M.createFromNode(p.ancestor(a.sc, p.isAnchor))),
            a.toString()
          );
        }),
      ...
      for (var v = 1; 6 >= v; v++)
        (this["formatH" + v] = (function (a) {
          ...
          b.memo("help.formatH" + v, i.help["formatH" + v]);
      (this.fontSize = function (b) {
        var c = this.createRange();
        if (c && c.isCollapsed()) {
          var e = l.styleNodes(c),
            f = d.head(e);
          a(e).css({ "font-size": b + "px" }),
            f &&
              !p.nodeLength(f) &&
              ((f.innerHTML = p.ZERO_WIDTH_NBSP_CHAR),
              M.createFromNodeAfter(f.firstChild).select(),
              g.data(T, f));
        } else s(), a(l.styleNodes(c)).css({ "font-size": b + "px" }), t();
      }),
        (this.insertHorizontalRule = this.wrapCommand(function () {
          var a = this.createRange().insertNode(p.create("HR"));
          a.nextSibling && M.create(a.nextSibling, 0).normalize().select();
        })),
        b.memo("help.insertHorizontalRule", i.help.insertHorizontalRule),
        ...
        (this.createLink = this.wrapCommand(function (b) {
          ...
          if (i) {
            ...
            j.push(k);
          } else j = l.styleNodes(g, { nodeName: "A", expandClosestSibling: !0, onlyPartialContains: !0 });
          a.each(j, function (b, d) {
            a(d).attr("href", c),
              f ? a(d).attr("target", "_blank") : a(d).removeAttr("target");
          });
        ...
        (this.pasteByEvent = function (a) {
          ...
          if (c && c.items && c.items.length) {
            ...
            "file" === e.kind &&
              ...
              b.invoke("editor.insertImagesOrCallback", [e.getAsFile()]),
    ...
    $ = function (b) {
      ...
      (this.toggle = function () {
        var a = function (a) {
          e.css("height", a.h),
            f.css("height", a.h),
            f.data("cmeditor") && f.data("cmeditor").setsize(null, a.h);
        };
        c.toggleClass("fullscreen"),
          this.isFullscreen()
            ? (e.data("orgHeight", e.css("height")),
              g
                .on("resize", function () {
        ...
        (this.replace = function () {
          if (this.lastWordRange) {
            ...
            if (d && (d[1] || d[2])) {
              ...
              this.lastWordRange.insertNode(h),
                (this.lastWordRange = null),
                b.invoke("editor.focus");
            }
          }
    ...
    da = function (b) {
      var e = this,
        ...
        k = (this.representShortcut = function (a) {
          var b = j[a];
          return (
            m.isMac && (b = b.replace("CMD", "⌘").replace("SHIFT", "⇧")),
            (b = b
              .replace("BACKSLASH", "\\")
              .replace("SLASH", "/")
              .replace("LEFTBRACKET", "[")
      ...
      (this.initialize = function () {
        ...
        (this.isFontInstalled = function (a) {
          return (
            e.fontInstalledMap.hasOwnProperty(a) ||
              (e.fontInstalledMap[a] =
                m.isFontInstalled(a) || d.contains(h.fontNamesIgnoreCheck, a)),
            e.fontInstalledMap[a]
          );
        }),
        (this.addToolbarButtons = function () {
            ...
            return f
              .buttonGroup([
                f.button({
                  ...
                  contents:
                    f.icon(h.icons.magic) + " " + f.icon(h.icons.caret, "span"),
          ...
          b.memo("button.justifyLeft", c.invoke(d, "render")),
            b.memo("button.justifyCenter", c.invoke(g, "render")),
            b.memo("button.justifyRight", c.invoke(j, "render")),
            b.memo("button.justifyFull", c.invoke(l, "render")),
            b.memo("button.outdent", c.invoke(m, "render")),
            b.memo("button.indent", c.invoke(n, "render")),
              ...
              return f
                .buttonGroup([
                  ...
                  f.dropdown([
                    ...
                    f.buttonGroup({ className: "note-list", children: [m, n] }),
                  ]),
                ])
                .render();
            }),
                  ...
                  ],
                  {
                    callback: function (a) {
                      ...
                      c.css({
                        ...
                        .on("mousemove", e.tableMoveHandler);
                    },
                  }
                )
                .render();
          ...
          for (var d = 0, e = c.length; e > d; d++) {
            for (
              var g = c[d],
                h = g[0],
                i = g[1],
                j = f.buttonGroup({ className: "note-" + h }).render(),
                k = 0,
                l = i.length;
              l > k;
              k++
        ...
        (this.tableMoveHandler = function (b) {
          ...
          i.css({ width: l.c + "em", height: l.r + "em" }),
            g.data("value", l.c + "x" + l.r),
            3 < l.c &&
              l.c < h.insertTableMaxSize.col &&
              j.css({ width: l.c + 1 + "em" }),
            3 < l.r &&
              l.r < h.insertTableMaxSize.row &&
              j.css({ height: l.r + 1 + "em" }),
            f.html(l.c + " x " + l.r);
        });
    },
    ea = function (b) {
      ...
      (this.shouldInitialize = function () {
        ...
        (this.initialize = function () {
          (f.toolbar = f.toolbar || []),
            f.toolbar.length
              ? b.invoke("buttons.build", e, f.toolbar)
              : e.hide(),
            f.toolbarContainer && e.appendTo(f.toolbarContainer),
            d.on(
        ...
        (this.updateCodeview = function (a) {
          c.toggleBtnActive(e.find(".btn-codeview"), a),
      ...
      (this.initialize = function () {
        var b = f.dialogsInBody ? a(document.body) : e,
          c =
            ...
            '</label><input class="note-link-text form-control" type="text" /></div><div class="form-group"><label>' +
            g.link.url +
            '</label><input class="note-link-url form-control" type="text" value="http://" /></div>' +
            (f.disableLinkTarget
              ? ""
              : '<div class="checkbox"><label><input type="checkbox" checked> ' +
                g.link.openInNewWindow +
                "</label></div>"),
          h =
            ...
            .Deferred(function (a) {
              ...
              d.onDialogShown(c.$dialog, function () {
                b.triggerEvent("dialog.shown"),
                  ...
                  e.url ||
                    ((e.url = e.text || "http://"), d.toggleBtn(h, e.text)),
                  g
                    .on("input", function () {
                      d.toggleBtn(h, f.val() && g.val()),
                        e.text || f.val(g.val());
                    })
                    .val(e.url)
                    .trigger("focus"),
                ...
                d.onDialogHidden(c.$dialog, function () {
                  f.off("input keypress"),
                    g.off("input keypress"),
                    h.off("click"),
    ...
    ha = function (b) {
      ...
      (this.initialize = function () {
        ...
        var j =
            ...
            c +
            '</div><div class="form-group" style="overflow:auto;"><label>' +
            g.image.url +
      ...
      (this.initialize = function () {
        ...
        (this.createVideoNode = function (b) {
          ...
          if (e && 11 === e[1].length) {
            ...
            c = a("<iframe>")
              .attr("frameborder", 0)
              .attr("src", "//www.youtube.com/embed/" + v)
              .attr("width", "640")
              .attr("height", "360");
    ...
    la = function (b) {
      ...
      (this.events = {
        ...
        "summernote.focusout": function (a, b) {
          m.isFF ||
            (b.relatedTarget &&
              p.ancestor(b.relatedTarget, c.eq(e.$popover[0]))) ||
            e.hide();
        },
      }),
        (this.shouldInitialize = function () {
    ...
    ma = function (b) {
      ...
      (this.events = {
        ...
        (this.replace = function () {
          ...
          if (a.length) {
            ...
            this.lastWordRange.insertNode(c),
              M.createFromNode(c).collapse().select(),
              (this.lastWordRange = null),
              this.hide(),
              b.invoke("editor.focus");
          }
        ...
        (this.createGroup = function (b, c) {
          ...
          return (
            this.searchKeyword(b, c, function (a) {
              (a = a || []),
                a.length && (d.html(e.createItemTemplates(b, a)), e.show());
            }),
            d
          );
        }),
