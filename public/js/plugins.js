var ResponsiveBootstrapToolkit = (function (e) {
  var t = {
      ...
      isMatchingExpression: function (e) {
        ...
        if (-1 !== s) {
          var r = 0,
            a = 0;
          "<" == n.operator && ((r = 0), (a = n.orEqual ? ++s : s)),
            ">" == n.operator && ((r = n.orEqual ? s : ++s), (a = void 0));
          var l = o.slice(r, a);
    ...
    i = {
      ...
      breakpoints: null,
      is: function (e) {
        return t.isAnExpression(e)
          ? t.isMatchingExpression(e)
          : i.breakpoints[e] && i.breakpoints[e].is(":visible");
      },
      use: function (e, n) {
        (i.framework = e.toLowerCase()),
          (i.breakpoints =
            "bootstrap" === i.framework || "foundation" === i.framework
              ? t.detectionDivs[i.framework]
              : n),
  ...
  return (
    ...
    null === i.framework && i.use("bootstrap"),
    i
  );
})(jQuery);
!(function (e) {
  ...
  (function (e) {
    ...
    function t(t) {
      ...
      if (
        ...
        "axis" in r && r.axis === r.HORIZONTAL_AXIS && ((d = p * -1), (p = 0)),
        (c = 0 === p ? d : p),
        "deltaY" in r && ((p = r.deltaY * -1), (c = p)),
        "deltaX" in r && ((d = r.deltaX), 0 === p && (c = d * -1)),
        0 !== p || 0 !== d)
      ) {
        if (1 === r.deltaMode) {
        ...
        if (
          ...
          (!s || f < s) && ((s = f), n(r, f) && (s /= 40)),
          n(r, f) && ((c /= 40), (d /= 40), (p /= 40)),
    ...
    (e.fn.jScrollPane = function (t) {
      function i(t, i) {
        function n(i) {
          ...
          if (((I = i), void 0 === L))
            (d = t.scrollTop()),
              ...
              (q = t.innerHeight()),
              t.width(O),
              (L = e('<div class="jspPane" />')
                .css("padding", ge)
                .append(t.children())),
              (F = e('<div class="jspContainer" />')
                .css({ width: O + "px", height: q + "px" })
                .append(L)
                .appendTo(t));
          else {
            if (
              ...
              (v = I.stickToBottom && C()),
              (g = I.stickToRight && B()),
              (u = t.innerWidth() + me != O || t.outerHeight() != q),
              u &&
                ((O = t.innerWidth() + me),
                (q = t.innerHeight()),
                F.css({ width: O + "px", height: q + "px" })),
              !u && je == N && L.outerHeight() == V)
            )
              return void t.width(O);
            (je = N),
              L.css("width", ""),
              t.width(O),
          ...
          L.css("overflow", "auto"),
            (N = i.contentWidth ? i.contentWidth : L[0].scrollWidth),
            (V = L[0].scrollHeight),
            L.css("overflow", ""),
            (G = N / O),
            (Q = V / q),
            ...
            K || $
              ? (t.addClass("jspScrollable"),
                (s = I.maintainPosition && (_ || te)),
                s && ((a = D()), (c = T())),
                o(),
                r(),
                l(),
                s && (y(g ? N - O : a, !1), k(v ? V - q : c, !1)),
                S(),
                A(),
                E(),
                I.enableKeyboardNavigation && Y(),
                I.clickOnTrack && p(),
                z(),
                I.hijackInternalLinks && W())
              : (t.removeClass("jspScrollable"),
                L.css({ top: 0, left: 0, width: F.width() - me }),
                H(),
                P(),
                X(),
                f()),
            I.autoReinitialise && !ve
              ? (ve = setInterval(function () {
                  n(I);
                }, I.autoReinitialiseDelay))
              : !I.autoReinitialise && ve && clearInterval(ve),
            d && t.scrollTop(0) && k(d, !1),
            h && t.scrollLeft(0) && y(h, !1),
            t.trigger("jsp-initialised", [K || $]);
        }
        function o() {
          $ &&
            (F.append(
              e('<div class="jspVerticalBar" />').append(
                e('<div class="jspCap jspCapTop" />'),
                e('<div class="jspTrack" />').append(
                  e('<div class="jspDrag" />').append(
                    e('<div class="jspDragTop" />'),
                    e('<div class="jspDragBottom" />')
                  )
                ),
                e('<div class="jspCap jspCapBottom" />')
              )
            ),
            (ie = F.find(">.jspVerticalBar")),
            (ne = ie.find(">.jspTrack")),
            (U = ne.find(">.jspDrag")),
            I.showArrows &&
              ((ae = e('<a class="jspArrow jspArrowUp" />')
                .bind("mousedown.jsp", u(0, -1))
                .bind("click.jsp", M)),
              (le = e('<a class="jspArrow jspArrowDown" />')
                .bind("mousedown.jsp", u(0, 1))
                .bind("click.jsp", M)),
              I.arrowScrollOnHover &&
                (ae.bind("mouseover.jsp", u(0, -1, ae)),
                le.bind("mouseover.jsp", u(0, 1, le))),
              c(ne, I.verticalArrowPositions, ae, le)),
            (se = q),
            F.find(
        ...
        function s() {
          ne.height(se + "px"),
            (_ = 0),
            (oe = I.verticalGutter + ne.outerWidth()),
            L.width(O - oe - me);
          try {
        ...
        function r() {
          K &&
            (F.append(
              e('<div class="jspHorizontalBar" />').append(
                e('<div class="jspCap jspCapLeft" />'),
                e('<div class="jspTrack" />').append(
                  e('<div class="jspDrag" />').append(
                    e('<div class="jspDragLeft" />'),
                    e('<div class="jspDragRight" />')
                  )
                ),
                e('<div class="jspCap jspCapRight" />')
              )
            ),
            (ce = F.find(">.jspHorizontalBar")),
            (ue = ce.find(">.jspTrack")),
            (J = ue.find(">.jspDrag")),
            I.showArrows &&
              ((fe = e('<a class="jspArrow jspArrowLeft" />')
                .bind("mousedown.jsp", u(-1, 0))
                .bind("click.jsp", M)),
              (he = e('<a class="jspArrow jspArrowRight" />')
                .bind("mousedown.jsp", u(1, 0))
                .bind("click.jsp", M)),
              I.arrowScrollOnHover &&
                (fe.bind("mouseover.jsp", u(-1, 0, fe)),
                he.bind("mouseover.jsp", u(1, 0, he))),
              c(ue, I.horizontalArrowPositions, fe, he)),
            J.hover(
              function () {
                J.addClass("jspHover");
              },
        ...
        function l() {
          if (K && $) {
            ...
            (se -= t),
              ...
              ue
                .parent()
                .append(e('<div class="jspCorner" />').css("width", t + "px")),
              s(),
              a();
          }
          K && L.width(F.outerWidth() - me + "px"),
            (V = L.outerHeight()),
            (Q = V / q),
            K &&
              ((pe = Math.ceil((1 / G) * de)),
              pe > I.horizontalDragMaxWidth
                ? (pe = I.horizontalDragMaxWidth)
                : pe < I.horizontalDragMinWidth &&
                  (pe = I.horizontalDragMinWidth),
              J.width(pe + "px"),
              (ee = de - pe),
              j(te)),
            $ &&
              ((re = Math.ceil((1 / Q) * se)),
              re > I.verticalDragMaxHeight
                ? (re = I.verticalDragMaxHeight)
                : re < I.verticalDragMinHeight &&
                  (re = I.verticalDragMinHeight),
              U.height(re + "px"),
              (Z = se - re),
              g(_));
        ...
        function d(t, i, n, o) {
          ...
          var s,
            ...
            a = !0,
            l = function () {
              0 !== t && be.scrollByX(t * I.arrowButtonSpeed),
                0 !== i && be.scrollByY(i * I.arrowButtonSpeed),
                (r = setTimeout(l, a ? I.initialDelay : I.arrowRepeatFreq)),
                (a = !1);
            };
          l(),
        ...
        function p() {
          f(),
            $ &&
              ne.bind("mousedown.jsp", function (t) {
                if (
                  ...
                  var i,
                    ...
                    a = function () {
                      ...
                      (i = setTimeout(
                        a,
                        r ? I.initialDelay : I.trackClickRepeatFreq
                      )),
                        (r = !1);
                    },
                    l = function () {
            ...
            K &&
              ue.bind("mousedown.jsp", function (t) {
                if (
                  void 0 === t.originalTarget ||
                  t.originalTarget == t.currentTarget
                ) {
          ...
          if ($) {
            ...
            if ((t.trigger(o, [i]), !o.isDefaultPrevented())) {
              var s = i || 0,
                ...
                l = i / Z,
                c = -l * (V - q);
              void 0 === n && (n = I.animateScroll),
                n
                  ? be.animate(U, "top", i, g, function () {
        ...
        function g(e) {
          ...
          (we != i || ye != n) &&
            ((we = i),
            (ye = n),
            t.trigger("jsp-arrow-change", [we, ye, ke, xe])),
            b(i, n),
            L.css("top", s),
            t.trigger("jsp-scroll-y", [-s, i, n]).trigger("scroll");
        }
        function m(i, n) {
          if (K) {
            0 > i ? (i = 0) : i > ee && (i = ee);
            ...
            if ((t.trigger(o, [i]), !o.isDefaultPrevented())) {
              ...
              void 0 === n && (n = I.animateScroll),
                n
                  ? be.animate(J, "left", i, j, function () {
        ...
        function j(e) {
          ...
          (ke != i || xe != n) &&
            ...
            w(i, n),
            L.css("left", s),
            t.trigger("jsp-scroll-x", [-s, i, n]).trigger("scroll");
        }
        function b(e, t) {
          I.showArrows &&
            (ae[e ? "addClass" : "removeClass"]("jspDisabled"),
            le[t ? "addClass" : "removeClass"]("jspDisabled"));
        }
        function w(e, t) {
          I.showArrows &&
            (fe[e ? "addClass" : "removeClass"]("jspDisabled"),
        ...
        function x(t, i, n) {
          ...
          (a = T()),
            (c = a + q),
            a > f || i
              ? (d = f - I.horizontalGutter)
              : f + s > c && (d = f - q + s + I.horizontalGutter),
            isNaN(d) || k(d, n),
            (l = D()),
            (u = l + O),
            l > h || i
              ? (p = h - I.horizontalGutter)
              : h + r > u && (p = h - O + r + I.horizontalGutter),
            isNaN(p) || y(p, n);
        }
        function D() {
          ...
          K && s.push(ce[0]),
            ...
            t
              ...
              .bind("keydown.jsp", function (t) {
                if (
                  t.target === this ||
                  (s.length && e(t.target).closest(s).length)
                ) {
                  var r = te,
                    a = _;
                  switch (t.keyCode) {
            ...
            I.hideFocus
              ? (t.css("outline", "none"),
                "hideFocus" in F[0] && t.attr("hideFocus", !0))
              : (t.css("outline", ""),
          ...
          if (location.hash && location.hash.length > 1) {
            ...
            t.length &&
              ...
              (0 === F.scrollTop()
                ...
                : (x(t, !0), e(document).scrollTop(F.position().top)));
          }
        }
        function W() {
        ...
        function E() {
          ...
          F.unbind(
            ...
            .bind("touchstart.jsp", function (r) {
            ...
            .bind("touchmove.jsp", function (r) {
              if (s) {
                var a = r.originalEvent.touches[0],
                  ...
                  c = _;
                return (
                  be.scrollTo(e + i - a.pageX, t + n - a.pageY),
                  (o =
                    o ||
                    Math.abs(i - a.pageX) > 5 ||
                    Math.abs(n - a.pageY) > 5),
                  l == te && c == _
                );
              }
            })
        ...
        function R() {
          ...
          t.removeClass("jspScrollable").unbind(".jsp"),
            L.unbind(".jsp"),
            t.replaceWith(De.append(L.children())),
            De.scrollTop(e),
            De.scrollLeft(i),
            ve && clearInterval(ve);
        }
